...
router.delete('/dashboard/interest', isAuthorized, catchErrors(dashboardController.deleteInterest));
router.post('/dashboard/skill', isAuthorized, catchErrors(dashboardController.addSkill));
router.delete('/dashboard/skill', isAuthorized, catchErrors(dashboardController.deleteSkill));
